...
public:
	...
	/**
	 * computes a triangle normal
	 * @param triangle the triangle to compute normal
	 */
	Normal computeNormalOf(Triangle triangle);
...
protected:
	...
	std::vector<Color> _trianglesColor;
	std::vector<Color> _verticesColor;
